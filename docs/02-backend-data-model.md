...
CREATE TABLE users (
  ...
  storage_quota    BIGINT NOT NULL DEFAULT 10737418240,    -- 10GB. V18 도입(2026-05-11), CHECK (>=0). entity 매핑은 Phase 3 (`docs/04 §6.1`).
  storage_used     BIGINT NOT NULL DEFAULT 0,              -- V18 도입(2026-05-11), CHECK (>=0). entity 매핑/enforcement는 Phase 3/5 (`docs/04 §6.1`).

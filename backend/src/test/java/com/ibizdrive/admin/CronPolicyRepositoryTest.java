...
/**
 * V11 시드(4 row) + V21 추가(admin.approval.expire) + V23 추가(favorites.cleanup) +
 * isEnabled query + update 동작 검증.
 *
...
class CronPolicyRepositoryTest {
    ...
    @Test
    void v11AndV21AndV23SeedsSixRowsAllDisabled() {
        // V11: 4 row + V21 (ADR #47 Phase 3d): admin.approval.expire + V23 (v1.x): favorites.cleanup → 총 6.
        ...
        assertThat(repository.isEnabled("favorites.cleanup")).isFalse();
    }

...
P2 — 백엔드: `AdminUserController` (`POST /api/admin/users`) + `@PreAuthorize("hasRole('ADMIN')")` + `AdminInviteUserRequest` Bean Validation, TDD.

진입점: `dev/active/admin-invite-email/admin-invite-email-tasks.md` Phase 2.

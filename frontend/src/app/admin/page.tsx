  ...
  return (
    <div className="p-8 max-w-[960px]">
      ...
      <p className="text-[13px] text-fg-2 mb-6">
        현재 가용 기능입니다. 운영 지표 / 권한 / 스토리지 등은 v1.x에서 추가됩니다.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
        ...
        <Link
          ...
          className="block p-4 rounded border border-border bg-surface-1 hover:bg-surface-2 transition-colors"
        >
          <div className="text-[14px] font-medium text-fg">부서</div>
          <div className="text-[12px] text-fg-2 mt-1">
            부서 생성 / 검색 / 이름 변경 / 활성 토글
          </div>
        </Link>
        <Link
          href="/admin/system"
          className="block p-4 rounded border border-border bg-surface-1 hover:bg-surface-2 transition-colors"
        >
          <div className="text-[14px] font-medium text-fg">시스템 정책</div>
          <div className="text-[12px] text-fg-2 mt-1">
            운영 cron 잡 설정 현재 상태 (read-only)
          </div>
        </Link>
      </div>
